package com.rulai.tool.log.dialect.log4j2;
...
import com.rulai.tool.log.AbstractLocationAwareLog;
...
private static final long serialVersionUID = -6843151523380063975L;
	...
	// ------------------------------------------------------------------------- Log
	@Override
	public void log(com.rulai.tool.log.level.Level level, String format, Object... arguments) {
		this.log(level, null, format, arguments);
	}
	
	@Override
	public void log(com.rulai.tool.log.level.Level level, Throwable t, String format, Object... arguments) {
		this.log(FQCN, level, t, format, arguments);
	}
	
	@Override
	public void log(String fqcn, com.rulai.tool.log.level.Level level, Throwable t, String format, Object... arguments) {
		Level log4j2Level;
		switch (level) {
			case TRACE:
