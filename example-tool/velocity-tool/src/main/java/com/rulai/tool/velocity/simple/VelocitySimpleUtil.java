package com.rulai.tool.velocity.simple;
...
public class VelocitySimpleUtil {
	 ...
	 * @throws Exception
	 */
	public static void generate(String inputVmFilePath, String outputFilePath, Map<String, Object> contextParmas) throws Exception {
		try {
