package com.rulai.upsso.clent.shiro.session;
...
import com.rulai.upsso.clent.util.SerializableUtil;
...
public class UpmsSessionDao extends CachingSessionDAO {
    ...
    protected void doDelete(Session session) {
        ...
        String upmsType = ObjectUtil.toString(session.getAttribute(UpmsConstant.UPMS_TYPE));
