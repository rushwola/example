package com.rulai.upsso.clent.interceptor;
...
import com.rulai.framework.common.util.RequestUtil;
import com.rulai.tool.core.util.ObjectUtil;
...
public class LogAspect {
	...
	public Object doAround(ProceedingJoinPoint pjp) throws Throwable {
		...
		if (request.getMethod().equalsIgnoreCase("GET")) {
			...
			upmsLog.setParameter(ObjectUtil.toString(request.getParameterMap()));
		}
		...
		upmsLog.setUrl(ObjectUtil.toString(request.getRequestURL()));
		upmsLog.setUserAgent(request.getHeader("User-Agent"));
		upmsLog.setUsername(ObjectUtil.toString(request.getUserPrincipal()));
