...
<head>
	...
	<link href="${basePath}/resources/rulai-admin-ui/plugins/bootstrap-3.3.0/css/bootstrap.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/rulai-admin-ui/plugins/material-design-iconic-font-2.2.0/css/material-design-iconic-font.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/rulai-admin-ui/plugins/waves-0.7.5/waves.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/rulai-admin-ui/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/rulai-admin-ui/css/admin.css" rel="stylesheet"/>
	<style>
		/** skins **/
	...
	<ul id="menu">
		...
		<li id="logo" class="hidden-xs">
			<a href="${basePath}/manage/index">
				<img src="${basePath}/resources/rulai-admin-ui/images/logo.png"/>
			</a>
...
<script src="${basePath}/resources/rulai-admin-ui/plugins/jquery.1.12.4.min.js"></script>
<script src="${basePath}/resources/rulai-admin-ui/plugins/bootstrap-3.3.0/js/bootstrap.min.js"></script>
<script src="${basePath}/resources/rulai-admin-ui/plugins/waves-0.7.5/waves.min.js"></script>
<script src="${basePath}/resources/rulai-admin-ui/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js"></script>
<script src="${basePath}/resources/rulai-admin-ui/plugins/BootstrapMenu.min.js"></script>
<script src="${basePath}/resources/rulai-admin-ui/plugins/device.min.js"></script>
<script src="${basePath}/resources/rulai-admin-ui/plugins/jquery.cookie.js"></script>
<script src="${basePath}/resources/rulai-admin-ui/js/admin.js"></script>
<script src="${basePath}/resources/rulai-admin-ui/plugins/fullPage/jquery.fullPage.min.js"></script>
<script src="${basePath}/resources/rulai-admin-ui/plugins/fullPage/jquery.jdirk.min.js"></script>
</body>
</html>