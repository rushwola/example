package com.rulai.tool.velocity.dao.model;

import java.io.Serializable;

public class UpssoUserOrganization implements Serializable {
    /**
     * 编号
     *
     * @mbg.generated
    ...
    public boolean equals(Object that) {
        ...
        UpssoUserOrganization other = (UpssoUserOrganization) that;
